...
def create_index():
    ...
    try:
        ...
        #compressed_retriever = ContextualCompressionRetriever(base_retriever)

        
       # parent_document_retriever = CohereRerank(compressed_retriever)
...
def upload_file():
    ...
    file_names = get_file_names(upload_dir)
